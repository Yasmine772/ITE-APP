    ...
    public function run(): void
  {
    ...
    //     }
        ...
        $adviceData = [
            ...
            [
                'subject_id' => 3,
                'content' => 'الرياضيات 3 تتطلب تطبيقًا عمليًا أكبر للمفاهيم الرياضية. لا تتردد في استخدام الأدوات البرمجية لفهم المشاكل وحلها.',
                'teacher_id' => 1,
            ],
            [
                'subject_id' => 4,
                'content' => 'الرياضيات 4 تركز على مواضيع متقدمة. حضّر للدروس مسبقًا وحاول حل الأمثلة المتقدمة. تعاون مع زملائك في المجموعات.',
                'teacher_id' => 1,
            ],
            [
                'subject_id' => 5,
